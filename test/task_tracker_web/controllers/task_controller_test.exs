defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{assigned_to: 42, completed: true, description: "some description", time_spent: 42, title: "some title"}
  @update_attrs %{assigned_to: 43, completed: false, description: "some updated description", time_spent: 43, title: "some updated title"}
  @invalid_attrs %{assigned_to: nil, completed: nil, description: nil, time_spent: nil, title: nil}
